...
router.post('/create-order', (req,res)=>{
    ...
    let message= `Thanks for shopping with us. Your ${req.body.course} Course is purchased Successfully. We will get back to you soon when new bacthes started. Regards E-Learning`
